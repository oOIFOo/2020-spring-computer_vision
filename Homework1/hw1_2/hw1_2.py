...
def process_one_image(img_path, pattern):
    ...
    ##############################################################
    pred = img * 255.0
    save_name = str(idx+1)+'_'+pattern+'_RAW.png'
    ...
    pred = img * 255.0
    save_name = str(idx+1)+'_'+pattern+'_AWB.png'
    save_img_path = os.path.join(img_folder_save_path, save_name)
    cv2.imwrite(save_img_path, pred)
    ...
    pred = img * 255.0
    save_name = str(idx+1)+'_'+pattern+'_demosaic.png'
    save_img_path = os.path.join(img_folder_save_path, save_name)
    cv2.imwrite(save_img_path, pred)
    ...
    pred = img * 255.0
    save_name = str(idx+1)+'_'+pattern+'_CC.png'
    save_img_path = os.path.join(img_folder_save_path, save_name)
    cv2.imwrite(save_img_path, pred)
    ...
    pred = img * 255
    save_name = str(idx+1)+'_'+pattern+'_XYZ.png'
    save_img_path = os.path.join(img_folder_save_path, save_name)
    cv2.imwrite(save_img_path, pred)
